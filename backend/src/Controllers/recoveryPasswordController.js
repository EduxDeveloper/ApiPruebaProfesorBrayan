...
const RecoveryEstudianteController = {};

RecoveryEstudianteController.requestCodePass = async (req, res) => {
try{
...
RecoveryEstudianteController.verifyCode = async (req, res) => {
...
RecoveryEstudianteController.changePassword = async (req, res) => {
    ...
    try {
        ...
        await estudiantesModels.findOneAndUpdate({email:decoded.email},
...
export default RecoveryEstudianteController;